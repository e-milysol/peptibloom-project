...
A human publication authority must approve release. Until a permanent role/RACI is frozen, Owner approval is required for publication.
...
- the workflow is sufficient to trace an approved publication package end to end.
