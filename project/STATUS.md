...
|---|---|---|
| Web | M0 complete; M1 architecture/launch plan ready | WEB M1 implementation authorization/execution |
...
| Evidence | architecture/reconciliation ongoing | approved public read contract before WEB M2 |
| Scientific Inventory | source/review workflow active | production-ready handoff to Evidence Layer |
...
WEB M2 must not proceed with compound data until the Evidence public contract and production-ready scientific content exist.
