...
Owner approval remains required until a permanent publication-authority RACI is frozen.
...
- an approved publication package can pass end to end without an ad-hoc scientific page or invented frontend data model.
